...
description: Implementer writes application code and minimal tests per 40-plan.plan.md; records work in 60-implementation-notes.md. In full mode expects 50-plan-review.md unless waived in manifest. Does not replace plan reviewer or code reviewer. Use after plan (and plan review in full) is ready.
...
- Add **targeted tests** where the plan or codebase warrants them; run checks and record commands in **`60-implementation-notes.md`**.
